...
function spawnPJ(player, data)
	...
	setElementData(player, 'idUnique:', data.ID)
	personajes[player] = {
		id = data.ID,
		userid = data.userID,
		nombre = data.nombre,
...
--aplicar sanciones--
	...
	triggerEvent('onCharacterLogin', player, personajes[player].id)
end
...
function savePlayer(player)
	...
	triggerEvent('onCharacterLogout', player, personajes[player].id)
