...
function openPicker(id, start, title, tipo)
  if id and not pickerTable[id] then
    pickerTable[id] = colorPicker.create(id, start, title, tipo)
...
function colorPicker.create(id, start, title, tipo)
  local cp = {}
  ...
  if tipo == "conce" then
        cp.gui.window = guiCreateWindow(0.01, 0.55, 0.26, 0.34, "Color", true)
        guiWindowSetSizable(cp.gui.window, false)
        guiSetAlpha(cp.gui.window, 0.50)
        cp.gui.svmap = guiCreateStaticImage(0.04, 0.11, 0.62, 0.84, "blank.png", true, cp.gui.window)
        cp.gui.hbar = guiCreateStaticImage(0.69, 0.11, 0.08, 0.84, "blank.png", true, cp.gui.window)
        cp.gui.blank = guiCreateStaticImage(0.81, 0.11, 0.15, 0.21, "blank.png", true, cp.gui.window)
        cp.gui.edith = guiCreateLabel(0.81, 0.35, 0.15, 0.07, "H: 257°", true, cp.gui.window)
        cp.gui.edits = guiCreateLabel(0.81, 0.41, 0.15, 0.07, "S: 70%", true, cp.gui.window)
        cp.gui.editv = guiCreateLabel(0.81, 0.48, 0.15, 0.07, "V: 61%", true, cp.gui.window)
        cp.gui.editr = guiCreateLabel(0.81, 0.56, 0.15, 0.07, "R: 77", true, cp.gui.window)
        cp.gui.editg = guiCreateLabel(0.81, 0.63, 0.15, 0.07, "G: 46", true, cp.gui.window)
        cp.gui.editb = guiCreateLabel(0.81, 0.69, 0.15, 0.07, "B: 156", true, cp.gui.window)  
  else
...
function colorPicker:destroy()
  ...
  if isElement(self.gui.okb) and isElement(self.gui.closeb) then
