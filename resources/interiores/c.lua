...
function renderPanel()
	if onSalePanel then
        dxDrawRectangle(screenW * 0.3931, screenH * 0.2956, screenW * 0.2206, screenH * 0.3689, tocolor(2,105,156, 161), false)
        dxDrawRectangle(screenW * 0.3931, screenH * 0.2400, screenW * 0.2206, screenH * 0.0500, tocolor(2,105,156, 161), false)
        ...
        if isCursorHover(screenW * 0.4144, screenH * 0.4667, screenW * 0.1769, screenH * 0.0544) then
        	dxDrawRectangle(screenW * 0.4144, screenH * 0.4667, screenW * 0.1769, screenH * 0.0544, tocolor(2,105,156, 161), false)
    	else
    		dxDrawRectangle(screenW * 0.4144, screenH * 0.4667, screenW * 0.1769, screenH * 0.0544, tocolor(2,105,156, 161), false)
    	end
    	if isCursorHover(screenW * 0.4144, screenH * 0.5989, screenW * 0.1769, screenH * 0.0544) then
        	dxDrawRectangle(screenW * 0.4144, screenH * 0.5989, screenW * 0.1769, screenH * 0.0544, tocolor(2,105,156, 161), false)
        else
        	dxDrawRectangle(screenW * 0.4144, screenH * 0.5989, screenW * 0.1769, screenH * 0.0544, tocolor(2,105,156, 161), false)
        end
